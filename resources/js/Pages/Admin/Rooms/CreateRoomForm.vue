    ...
    <jet-form-section @submitted="createRoom">
      ...
      <template #form>
        ...
        <div class="col-span-6 sm:col-span-3">
          ...
          />
          <jet-input-error
            :message="createRoomForm.error('name')"
            class="mt-2"
          />
        </div>
        ...
        <div class="col-span-6 sm:col-span-3">
          <jet-label
            for="min_days_advance"
            value="Minimum Days Before Booking"
          />
          <jet-input
            id="min_days_advance"
        ...
        <div class="col-span-6 sm:col-span-3">
          <jet-label
            for="max_days_advance"
            value="Maximum Days Before Booking"
          />
          <jet-input
            id="max_days_advance"
      ...
      <template #actions>
        <jet-action-message
          :on="createRoomForm.recentlySuccessful"
          class="mr-3"
        >
          Created.
        </jet-action-message>
