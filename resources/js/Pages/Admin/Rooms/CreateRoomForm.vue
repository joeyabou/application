<template>
  <jet-form-section @submitted="createRoom">
    ...
    <template #form>
      ...
      <div class="col-span-6 sm:col-span-3">
        ...
        <jet-input
          ...
          type="roomnumber"
          class="mt-1 block w-full"
          v-model="createRoomForm.number"
        />
        <jet-input-error
          :message="createRoomForm.error('roomnumber')"
          class="mt-2"
        />
      </div>
      ...
      <div class="col-span-6 sm:col-span-3">
        ...
        <jet-input
          ...
          min="0"
          class="mt-1 block w-full"
          v-model="createRoomForm.floor"
        />
        <jet-input-error
          :message="createRoomForm.error('floor')"
          class="mt-2"
        />
      </div>
      ...
      <div class="col-span-6 sm:col-span-3">
        ...
        />
        <jet-input-error
          :message="createRoomForm.error('building')"
          class="mt-2"
        />
      </div>
      ...
      <div class="col-span-6 sm:col-span-3">
        ...
        />
        <jet-input-error
          :message="createRoomForm.error('capacity_standing')"
          class="mt-2"
        />
      </div>
      ...
      <div class="col-span-6 sm:col-span-3">
        ...
        />
        <jet-input-error
          :message="createRoomForm.error('sit_capacity')"
          class="mt-2"
        />
      </div>
      ...
      <div class="col-span-6 sm:col-span-3">
        ...
        <input
          ...
          id="checkbox"
          class="form-checkbox"
          v-model="createRoomForm.alcohol"
        />
        <jet-input-error
          :message="createRoomForm.error('alcohol')"
          class="mt-2"
        />
      </div>
      ...
      <div class="col-span-6 sm:col-span-3">
        ...
        <input
          ...
          id="checkbox"
          class="form-checkbox"
          v-model="createRoomForm.a_v_permitted"
        />
        <jet-input-error
          :message="createRoomForm.error('a_v_permitted')"
          class="mt-2"
        />
      </div>
      ...
      <div class="col-span-6 sm:col-span-3">
        ...
        <jet-input-error
          :message="createRoomForm.error('status')"
          class="mt-2"
        />
      </div>
      ...
      <div class="col-span-6 sm:col-span-3">
        ...
        <label class="flex items-center">
          <input
            type="checkbox"
            class="form-checkbox"
            v-model="createRoomForm.projector"
          />
        ...
        <label class="flex items-center">
          <input
            type="checkbox"
            class="form-checkbox"
            v-model="createRoomForm.television"
          />
        ...
        <label class="flex items-center">
          <input
            type="checkbox"
            class="form-checkbox"
            v-model="createRoomForm.computer"
          />
        ...
        <label class="flex items-center">
          <input
            type="checkbox"
            class="form-checkbox"
            v-model="createRoomForm.whiteboard"
          />
          <span class="ml-2 text-sm text-black">Whiteboard</span>
        </label>
        <jet-input-error
          :message="createRoomForm.error('equippment')"
          class="mt-2"
        />
      </div>
      ...
      <div class="col-span-6 sm:col-span-3">
        ...
        <label class="flex items-center">
          <input
            type="checkbox"
            class="form-checkbox"
            v-model="createRoomForm.ambiant_music"
          />
        ...
        <label class="flex items-center">
          <input
            type="checkbox"
            class="form-checkbox"
            v-model="createRoomForm.sale_for_profit"
          />
        ...
        <label class="flex items-center">
          <input
            type="checkbox"
            class="form-checkbox"
            v-model="createRoomForm.fundraiser"
          />
          <span class="ml-2 text-sm text-black">Fundraiser</span>
        </label>
        <jet-input-error
          :message="createRoomForm.error('restrictions')"
          class="mt-2"
        />
      </div>
      ...
      <div class="col-span-6 sm:col-span-3">
        ...
        <jet-input
          v-model.number="createRoomForm.sofas"
          type="number"
          min="0"
        />
        ...
        <jet-input
          v-model.number="createRoomForm.coffee_tables"
          type="number"
          min="0"
        />
        ...
        <jet-input
          v-model.number="createRoomForm.tables"
          type="number"
          min="0"
        />
        ...
        <jet-input
          v-model.number="createRoomForm.chairs"
          type="number"
          min="0"
        />

        <jet-input-error
          :message="createRoomForm.error('furniture')"
          class="mt-2"
        />
      </div>

      <br />
      <div v-on:click="toggle" class="col-span-6 sm:col-span-6">
        <br />
      ...
      >
        ...
        <jet-input-error
          :message="
            createRoomForm.error('availabilities.' + key + '.opening_hours')
          "
          class="mt-2"
        />
        ...
        <jet-input-error
          :message="
            createRoomForm.error('availabilities.' + key + '.closing_hours')
          "
          class="mt-2"
        />
      </div>

      <div v-show="showAvailabilities" class="col-span-6 sm:col-span-3">
        ...
        />
        <jet-input-error
          :message="createRoomForm.error('min_days_advance')"
          class="mt-2"
        />
        ...
        />
        <jet-input-error
          :message="createRoomForm.error('max_days_advance')"
          class="mt-2"
        />
      </div>
    </template>
    ...
    <template #actions>
      ...
      <jet-button
        :class="{ 'opacity-25': createRoomForm.processing }"
